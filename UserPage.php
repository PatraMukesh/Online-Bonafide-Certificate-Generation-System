    ...
    <div class="main_div">
        <div class="top_div">
            ...
            <ul>
                ...
                <div class="dropdown">
                     <li><a href="#">Certificates <i class="fa fa-caret-down"></i></a></li>
                        <div class="dropdown-content">
                        <a href="Application_Page.php">Apply Bonafide Certificates</a>
                        <?php
                        $connection=mysqli_connect("localhost","root","","bonafide_db");
                        $cmd="select user_id from student";
                        ...
                        {
                         echo "<a href='Download.php'>Download Bonafide Certificates</a>";
                        }
                        }
                        ?>
                        </div>
...
<?php
     ...
     $cmd="select * from student where user_id='$id'";
     $dis=mysqli_query($conn,$cmd);
     $n=mysqli_num_rows($dis);
     while($rows=mysqli_fetch_assoc($dis))
     {
             $_SESSION["Name"]= $rows['name'];
             $_SESSION["Fname"]= $rows['father'];
             $_SESSION["Reg"]= $rows['reg_no'];
